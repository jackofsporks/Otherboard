...
export default class HtmlSelectors {
  constructor() {
    ...
    k.div = {
      ...
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "structural", "generic", "wrapper",
      "div"]
    }
    ...
    k.a = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "embedded", "phrasing",
    ...
    k.span = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "generic", "wrapper", "span", "inline"] // structure???
    }
    ...
    k.ol = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "list", "ordered list"]
    }
    ...
    k.ul = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "list", "unordered list"]
    }
    ...
    k.li = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "list", "list item", "item"]
    }
    ...
    k.h1 = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "heading", "structure",
    ...
    k.main = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "outline", "layout", "structure", "main"]
    }
    k.nav = {
      id: "nav", displayName: "nav", toSimulate: "nav",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "outline", "layout", "structure", "sectioning",
      "nav", "navigation bar"]
    }
    k.section = {
    ...
    k.header = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "outline", "layout", "structure", "header"]
    }
    k.footer = {
      id: "footer", displayName: "footer", toSimulate: "footer",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "outline", "layout", "structure", "footer"]
    }
    k.aside = {
      id: "aside", displayName: "aside", toSimulate: "aside",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "outline", "layout", "structure", "sectioning", "aside"]
    }
    k.article = {
      id: "article", displayName: "article", toSimulate: "article",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "outline", "layout", "structure", "sectioning", "article"]
    }
    ...
    k.form = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form"]
    }
    ...
    k.label = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "label"]
    }
    ...
    k.input = {
      ...
      // activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "input"]
    }
    ...
    k.button = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "button"]
    }
    ...
    k.textarea = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "textarea"]
    }
    ...
    k.fieldset = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "fieldset"]
    }
    ...
    k.optgroup = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "optgroup"]
    }
    ...
    k.option = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "option"]
    }
    ...
    k.select = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "select"]
    }
    ...
    k.legend = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "legend"]
    }
    ...
    k.datalist = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "datalist"]
    }
    ...
    k.object = { // css???
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "object"]
    }
    ...
    k.param = { // css???
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "param"]
    }
    ...
    k.meter = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "meter"]
    }
    // Not fully supported
    k.output = { // css???
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "interaction", "user", "ui", "ux", "form", "output"]
    }
    ...
    k.video = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "embedded", "image", "media", "file",
      "video", "clip", "film"]
    }
    ...
    k.canvas = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "embedded", "image", "media",
      "canvas", "drawing"]
    }
    ...
    k.audio = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "embedded", "media", "music", "volume", "file",
      "audio", "sound"]  // volume???
    }
    ...
    k.iframe = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "embedded", "document", "iframe"]
    }
    ...
    k.embed = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "embedded", "embed"]
    }
    ...
    k.math = { // css???
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "embedded", "math"]
    }
    ...
    k.table = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "table"]
    }
    k.tr = {
      id: "tr", displayName: "tr", toSimulate: "tr",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "table", "tr", "table row"]
    }
    k.th = {
    ...
    k.tfoot = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "table", "tfoot", "table footer section"]
    }
    k.tbody = {
      id: "tbody", displayName: "tbody", toSimulate: "tbody",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "table", "tbody", "table body section"]
    }
    k.colgroup = {
      id: "colgroup", displayName: "colgroup", toSimulate: "colgroup",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "table", "colgroup", "column group attributes"]
    }
    k.col = {
      id: "col", displayName: "col", toSimulate: "col",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "table", "col", "column attributes"]
    }
    k.caption = {
      id: "caption", displayName: "caption", toSimulate: "caption",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "table", "caption"]
    }
    ...
    k.html = {
      ...
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "document structure", "root"]
    }
    k.body = {
      id: "body", displayName: "body", toSimulate: "body",
      classes: ["snippet", "html", "tag"],
      activate: keyFuncs.pureSimulation,
      tags: ["html", "selector", "document structure",
      "body"]
    }
