...
import History from "./history-view.js"
...
// TODO: Add ability to change displayName
  ...
  constructor(source) {
    ...
    view.minibar = utils.addNode('osk-minibar', null, ["closed"], view.node)
    view.config = utils.addNode('osk-config', null, null, view.node)
    new UserConfigView2({}, view.minibar, source) // after config is defined
    ...
    new History({}, view.history, source) // after config is defined
