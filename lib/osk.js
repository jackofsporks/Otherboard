...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      // aborting for now because command takes over everything even when not activated and breaks more stuff laterz
      "osk:cancel": function testing(e) {test(e)}
    }))
    // 'ctrl-alt-a' --> 'ascii-art:convert' --> convert(){whatevs}
    // 'ctrl-alt-o' --> 'osk:toggle' --> this.toggle
  },
