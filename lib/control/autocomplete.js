...
export default class AutocompleteThief {
  ...
  testKeydown(e){
    ...
    console.log(keyAtomName, aThief.confirming, "-- does contain name -->", doesContain)
  ...
  selectOnHover (elm) {
    ...
    // Is it enough to add a class to the hovered item? Or does autocomplete need other stuff done too? If the latter can we even do that stuff without breaking more things?
    // TODO NEXT Find setSelectedIndex in acp suggestion list element
