...
export default class AutocompleteThief {
  constructor(osk, key) {
    // TODO URGENT!!! some keys, like "<></>" aren't ever going to autocomplete. They need provisions.
    // TODO COOL!!!!! make scope by giving classes to inserted text?!?!?! (or to something. look at how to make scope in atom)
    ...
    // TODO Turn on text autocomplete (built-in provider) for the alphabetical keyboard
